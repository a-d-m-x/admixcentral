...
${RUNTIME_WEB_USER} ALL=(ALL) NOPASSWD: /usr/bin/supervisorctl reread, /usr/bin/supervisorctl update, /usr/bin/supervisorctl restart admix-worker:*, /usr/bin/supervisorctl restart admix-reverb:*
